...
-   एसएएम को C++11 की आवश्यकता है। में होना आवश्यक है`%LOCALAPPDATA%\Arduino15\packages\arduino\hardware\sam\*.*.*\platform.txt`तटस्थ`-std=gnu++11`बाद में जोड़ें`-fpermissive`पैरामीटर.
