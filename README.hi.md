...
-   `<iostream> cin cout endl`मानक इनपुट और आउटपुट स्ट्रीम के रूप में सीरियल पोर्ट का उपयोग करें। हालाँकि, उपयोगकर्ताओं को अभी भी मैन्युअल रूप से कॉल करने की आवश्यकता है`Serial.begin`, यह मानते हुए कि सीरियल पोर्ट कनेक्ट नहीं हो सकता है या बॉड दर 9600 नहीं है।
-   `<map>`
...
आप कौन सा सीरियल पोर्ट बदल सकते हैं`cin`,`cout` and `printf()`उपयोग। आप अंतर्निर्मित सीरियल पोर्ट का उपयोग कर सकते हैं (उदा.`Serial1`लियोनार्डो पर) या आप लागू करने वाले सॉफ़्टवेयर सीरियल पोर्ट का उपयोग कर सकते हैं`Stream`.
