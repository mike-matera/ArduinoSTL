...
-   `<iostream> cin cout endl`मानक इनपुट और आउटपुट स्ट्रीम के रूप में सीरियल पोर्ट का उपयोग करें। हालाँकि, उपयोगकर्ताओं को अभी भी मैन्युअल रूप से कॉल करने की आवश्यकता है`Serial.begin`，考虑到串口可能未连接或者波特率不是9600的情况。
-   `<map>`
...
में`src/ArduinoSTL.cpp`का मान बदलें`ARDUINOSTL_DEFAULT_SERIAL`. Leave the other defaults uncommented. 
