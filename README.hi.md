...
के बाद से[मूल ArduinoSTL](https://github.com/mike-matera/ArduinoSTL)कोई अपडेट नहीं है या बहुत लंबा समय है (202203~202212), मैंने इस शाखा को Arduino सार्वजनिक लाइब्रेरी में जारी किया और इसे अलग करने के लिए इसका नाम Cpp_Standard_Library रखा।

यह लाइब्रेरी Arduino पर C++11~17 मानक लाइब्रेरी (STL) की अधिकांश कार्यक्षमता को लागू करने का प्रयास करती है। ArduinoSTL के अलावा, इस लाइब्रेरी के कुछ कार्यात्मक कार्यान्वयन MSVC, LLVM और बूस्ट को भी संदर्भित करते हैं। चूँकि इंटरफ़ेस STL के अनुसार बनाए जाते हैं, इसलिए अतिरिक्त दस्तावेज़ लिखने की कोई आवश्यकता नहीं है, आप किसी भी आधिकारिक STL दस्तावेज़ का उल्लेख कर सकते हैं। जब तक अन्यथा उल्लेख न किया गया हो, इस पुस्तकालय का उपयोग और व्यवहार समान होना चाहिए; यदि भिन्न है, तो यह एक बग होना चाहिए और समस्या प्रस्तुत करने के लिए आपका स्वागत है।

यदि आपको कुछ ऐसी सुविधाओं की आवश्यकता है जो मानक पुस्तकालय में उपलब्ध हैं लेकिन अभी तक इस पुस्तकालय में उपलब्ध नहीं हैं, तो एक मुद्दा प्रस्तुत करने के लिए आपका भी स्वागत है, और लेखक आपके लिए इसे लागू करने को प्राथमिकता देगा।

AVR और SAM आर्किटेक्चर वर्तमान में समर्थित हैं। वर्तमान में ESP32 को समर्थन देने की कोई योजना नहीं है, क्योंकि ESP32 ने आधिकारिक तौर पर एक मानक पुस्तकालय प्रदान किया है। समानांतर में दो मानक पुस्तकालयों का उपयोग करने से बहुत सारी पेचीदा समस्याएं पैदा होती हैं।

# हस्ताक्षर सुविधाएँ (यह तक सीमित नहीं) हस्ताक्षर सुविधाएँ (यह तक सीमित नहीं)
...
टिप्पणी करना`ARDUINOSTL_DEFAULT_CIN_COUT` and nothing will be instantiated. You must comment out this flag if you intend to select a non-default serial port. There's no appreciable overhead for using `printf()`इसलिए आप फिलहाल इसे आरंभ करने से बच नहीं सकते।

## ज्ञात पहलु

फ़्लोट्स और डबल्स का उपयोग करके मुद्रण`cout`प्रारूप विनिर्देशकों को अनदेखा करता है।

uClibc काफी हद तक पूर्ण प्रतीत होता है। स्ट्रिंग और वेक्टर दोनों काम करते हैं, भले ही Arduino के पास सीमित मात्रा में हीप उपलब्ध हो। uClibc++ स्थिति पृष्ठ यहां पाया जा सकता है:
