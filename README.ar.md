...
-   `<functional> std::function`السلوك غير القياسي: عدم القيام بأي شيء عند استدعائه على كائن فارغ. وذلك لأن السلوك القياسي هو أنه يجب طرح استثناء، لكن Arduino لا يدعم الاستثناءات. إذا كنت لا تريد القيام بأي شيء عند استدعاء كائن فارغ، فيمكنك الاتصال به مباشرةً دون التحقق مما إذا كان الكائن فارغًا.
